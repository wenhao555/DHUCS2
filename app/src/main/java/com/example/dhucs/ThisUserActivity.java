    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull int position) {
                ...
                LayoutInflater layoutInflater = LayoutInflater.from(ThisUserActivity.this);
                View newPlanDialog = layoutInflater.inflate(R.layout.baoming_dia, null);
                AlertDialog.Builder builder = new AlertDialog.Builder(ThisUserActivity.this);
                ...
                if (activities.getWorkLong() != null && !activities.getWorkLong().equals(""))
                    ac_time.setText(activities.getWorkLong());
                if (activities.getTimeLong() != null && !activities.getTimeLong().equals(""))
                    ac_date.setText(activities.getTimeLong());
                builder.setTitle("提示")
    ...
    private void initData() {
        adapter = new BaseRecyclerAdapter() {
            ...
            protected void onBindView(@NonNull BaseViewHolder holder, @NonNull final int position) {
                ...
                if (activities.getAccess() != null) {//通过集合
                    if (activities.getAccess()) {
                        item_pass.setText("已通过");
                        if (activities.getActivityAdmin() != null) {//是否是管理员
                ...
                item_pass.setOnClickListener(new View.OnClickListener() {// 通过
                    @Override
                    public void onClick(View v) {
                ...
                item_setting.setOnClickListener(new View.OnClickListener() {//取消管理员||设置管理员
                    @Override
                    public void onClick(View v) {
