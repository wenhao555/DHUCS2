 ...
 */
public class AdminFengFragment extends Fragment
{

    public AdminFengFragment()
    {
        // Required empty public constructor
    }

    private ImageView addfeng;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View view = inflater.inflate(R.layout.fragment_admin_feng, container, false);
        requestData();
        addfeng = view.findViewById(R.id.addfeng);
        addfeng.setOnClickListener(new View.OnClickListener()
        {
            @Override
